...
/**
 * Unit tests for {@link CompositeAffinityTeamPlayerMixIn}.
 * <p>
 ...
 */
public final class TestCompositeAffinityTeamPlayerMixIn {

    /**
     * Default constructor.
     */
    public TestCompositeAffinityTeamPlayerMixIn() {
        super();
    }
    ...
    private final String getJson() throws JsonProcessingException {
        ...
        final Collection<Role> roles;               // Player roles
        final CompositeAffinityTeamPlayer player;   // Mocked player
        ...
        mapper.addMixIn(CompositeAffinityTeamPlayer.class,
                CompositeAffinityTeamPlayerMixIn.class);
        ...
        // Mocks player
        player = Mockito.mock(CompositeAffinityTeamPlayer.class);
