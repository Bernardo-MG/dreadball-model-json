...
import com.bernardomg.tabletop.dreadball.model.json.player.component.CompositeAdvancementTeamPlayerMixIn;
...
/**
 * Unit tests for {@link CompositeAdvancementTeamPlayerMixIn}.
 * <p>
 ...
 */
public final class TestCompositeAdvancementTeamPlayerMixIn {

    /**
     * Default constructor.
     */
    public TestCompositeAdvancementTeamPlayerMixIn() {
        super();
    }
    ...
    private final String getJson() throws JsonProcessingException {
        ...
        mapper.addMixIn(CompositeAdvancementTeamPlayer.class,
                CompositeAdvancementTeamPlayerMixIn.class);
